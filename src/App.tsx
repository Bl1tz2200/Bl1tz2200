...
// Profile data
const profile = {"name":"Bl1tz2200","bio":"Lifelong Student","avatarUrl":"/assets/avatar.png","theme":"light","primaryColor":"blue","showBranding":true,"analytics":{"enabled":false,"supabaseUrl":""},"socialAccounts":[]}
const blocks: BlockData[] = [{"id":"6nv6jmco3","type":"SOCIAL","title":"Telegram","content":"https://t.me/bl1tz2200","colSpan":1,"rowSpan":2,"color":"bg-blue-500","textColor":"text-white","gridColumn":1,"gridRow":1,"socialPlatform":"telegram","socialHandle":"bl1tz2200","subtext":"@\""}]
